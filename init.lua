...
print("NodeMCU Started")
	...
	gpio.mode(1, gpio.INPUT, gpio.PULLUP)--security in case of bad algorythm and intenpestive reboot
	
	if gpio.read(1) == 1 then
        
        print("In case of fail, pullDown gpio1 (D1)")
        ...
        print("D1 PullDown, start aborted")
	end
